...
function begin_play(){
	...
	var p1_name = document.getElementById("player1_id");
	var p2_name = document.getElementById("player2_id");
	...
	if(p1_name.value == "" || p2_name.value == "" )
	{
		...
		started = true;
		p1_name.disabled = true;
		p2_name.disabled = true;
		if(check == false){
			p1_name.value = p1_name.value + ' (X)';
			p2_name.value = p2_name.value + ' (O)';
			check = true;
		}
...
function reset_play(){
	...
	p2_name.value = "";
	move_text.value = "";
	p1_name.disabled = false;
	p2_name.disabled = false;
